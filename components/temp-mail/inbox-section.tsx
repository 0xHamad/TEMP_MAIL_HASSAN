...
const DEMO_EMAILS: EmailMessage[] = [
  {
    ...
    body_html: `<div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; color: #1a1a2e;">
      <h2 style="color: #0f2167;">Verify your email</h2>
      <p>Please verify your email address by clicking the button below:</p>
      <a href="#" style="display:inline-block; padding: 10px 20px; background: #2563eb; color: white; border-radius: 8px; text-decoration: none;">Verify Email</a>
      <p style="color: #666; font-size: 13px; margin-top: 20px;">This link expires in 24 hours.</p>
    </div>`,
    body_text: "Please verify your email by clicking the link.",
  ...
  },
  {
    ...
    body_html: `<div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; color: #1a1a2e;">
      <h2 style="color: #5865f2;">Your Discord Code</h2>
      <p>Use this code to verify your account:</p>
      <div style="background: #f0f2ff; border-radius: 12px; padding: 20px; text-align: center; margin: 16px 0;">
        <span style="font-size: 36px; font-weight: 700; font-family: monospace; letter-spacing: 8px; color: #5865f2;">847293</span>
      </div>
    ...
    received_at: Date.now() - 480000,
    read: true,
  },
];

export function InboxSection() {
  const { currentEmail, expiresAt, extendTime, deleteInbox, generateNewEmail } = useEmailStore();
  ...
  const handleDelete = () => {
    ...
    setEmails([]);
    setSelected(null);
    toast.success("Inbox cleared — new address generated");
  };
                  ...
                  <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border bg-muted/20">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-xs text-muted-foreground truncate">From: {selected.from}</span>
                      </div>
                    </div>
